...
Public API (Render): [https://linear-regression-model-api-0zt6.onrender.com](https://linear-regression-model-api-0zt6.onrender.com/docs)

## Flutter
```bash
cd summative/FlutterApp
flutter pub get
flutter run --dart-define=API_BASE_URL=https://linear-regression-model-api-0zt6.onrender.com
```
